...
public class UserData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//セッションから取得したuserIdを引数に渡してDAOを実行する
			List<BuyDataBeans> BuyDataList = BuyDAO.getBuyDataBeansByBuyUserId(userId);
			...
			//t_buyテーブルのデータが入ったBuyDataBeansインスタンスのLISTをuserdata.jspにスコープを使って渡す
